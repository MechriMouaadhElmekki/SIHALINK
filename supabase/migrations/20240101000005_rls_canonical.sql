-- ============================================================
-- SIHALINK — Migration 005: Canonical RLS
...
DROP POLICY IF EXISTS "facilities_public_select"     ON healthcare_facilities;
...
-- DOCTORS (authenticated read of active)
...
-- HEALTHCARE FACILITIES (authenticated read)
CREATE POLICY "facilities_public_select" ON healthcare_facilities
  FOR SELECT
  USING (auth.uid() IS NOT NULL);
